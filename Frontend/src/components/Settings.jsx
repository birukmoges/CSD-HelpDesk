...
import { AiOutlineSetting, AiOutlineUser, AiOutlineHome, AiOutlineTool , AiOutlineEye, AiOutlineEyeInvisible} from "react-icons/ai";
  ...
  const handleResetPassword = async () => {
    try {
      ...
      const response = await axios.post(
        "http://localhost:3000/api/v1/users/renew-password",
        {
          email: email,
    ...
    <div className="max-w-[1640px] mx-auto px-4 py-12">
      ...
      <div className="flex items-center mb-4 relative">
        ...
        <div className="relative w-full">
          <input
            className="bg-transparent p-2 w-full pr-10 focus:outline-none border-b border-gray-500"
          ...
          <button
            type="button"
            className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500 border-none outline-none focus:ring-0 "
