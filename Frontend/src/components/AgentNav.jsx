...
>
  ...
  <nav>
    <ul className="flex flex-col p-4 text-gray-800">
      ...
      <li
        className="text-xl py-4 flex items-center transition ease-in-out duration-300 hover:bg-blue-50 !important hover:shadow-md !important cursor-pointer"
        onClick={() => {
